...
import { KanbanUpdateTaskMutation, KanbanUpdateTaskMutationVariables } from "../../../graphql/types";
...
export const DescriptionForm = ({ initialValues, cancelForm }: Props) => {
  ...
  const { formProps, saveButtonProps } = useForm<
    GetFields<KanbanUpdateTaskMutation>,
    HttpError,
    /**
     ...
     */
    Pick<GetVariables<KanbanUpdateTaskMutationVariables>, "description">
  >({
    queryOptions: {
